 ...
 */
exports.find = function(obj, args) {
...
exports.csv = function(obj, args) {
  ...
  return execargs(args, function(arg) {
    assert(typeof arg === 'string');
    console.log('csv', obj, arg, CSV.stringify(obj, arg));
 ...
 */
exports.uncsv = function(obj, args) {
  var CSV = require('csv-string');
  return execargs(args, function(arg) {
    assert(typeof arg === 'string');
 ...
 */
exports.unjson = function(obj, args) {
  return execargs(args, function(arg) {
...
exports.template = function(obj, args) {
  ...
  return execargs(args, function(arg) {
    ...
    extend(env, obj);
    return mustache.render(arg, env);
  });
}
