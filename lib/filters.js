...
exports.cast = function(obj, args) {
 ...
 exports.xml = function(obj, args){
   return require('xml-mapping').dump(obj, args);
 };

 /**
  * Packs the *input* into XML string
  */
 exports.parseXML = function(obj, args){
   return require('xml-mapping').load(obj, args);
 };
 ...
 exports.sortBy = exports.sort_by = function(obj, prop){
 ...
 exports.dividedBy = exports.divided_by = function(a, b){
   return Number(a) / Number(b);
 };
